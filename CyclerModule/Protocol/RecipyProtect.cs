...
namespace CyclerModule.Protocol
{
    ...
    public class RecipyProtect : ICyclerProtocol, IEnumerable
    {
        //                                  [[[ 설명 ]]]                     [[[ 단위 ]]]     [[[ 비고 ]]]
        public int VoltUpperLimite;         // 전압 상한                     (0.1 mV)
        public int VoltLowerLimite;         // 전압 하한                     (0.1 mV)
        public int CurrUpperLimite;         // 전류 상한                     (0.1 mA)
        public int CurrLowerLimite;         // 전류 하한                     (0.1 mA)
        public int CapaUpperLimite;         // 용량 상한                     (0.1 mAh)
        public int TempUpperLimite;         // 온도 상한                     (0.1 ℃)

        int[] spare;                        // 스페어 6개

        public RecipyProtect()
        {
            spare = new int[6];
        }
        ...
        {
            yield return VoltUpperLimite;
            yield return VoltLowerLimite;
            yield return CurrUpperLimite;
            yield return CurrLowerLimite;
            yield return CapaUpperLimite;
            yield return TempUpperLimite;
