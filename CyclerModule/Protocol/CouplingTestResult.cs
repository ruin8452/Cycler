...
namespace CyclerModule.Protocol
{
    ...
    public class CouplingTestResult : ICyclerProtocol, IEnumerable
    {
        //                                  [[[ 설명 ]]]                     [[[ 단위 ]]]     [[[ 비고 ]]]
        ...
        public int ResultChargeIR;          // 충전 저항 결과                (uΩ)
        public int ResultDischargeIR;       // 방전 저항 결과                (uΩ)
        private int _resultStatus;          // 체결 테스트 결과                               [0: 실패, 1: 성공]
        ...
        public int ResultStatus
        {
            ...
            set
            {
                if (0 <= value && value <= 1) _resultStatus = value;
                else throw new InvalidOperationException("Over Range");
            }
        }
        ...
        public bool ToClass(byte[] byteArray)
        {
            ...
            SetMode             = (int)SliceAndConvert(ref tempArray, typeof(int));
            SetChargeVolt       = (int)SliceAndConvert(ref tempArray, typeof(int));
            SetDishargeVolt     = (int)SliceAndConvert(ref tempArray, typeof(int));
            SetCurr             = (int)SliceAndConvert(ref tempArray, typeof(int));
            SetEndTIme          = (int)SliceAndConvert(ref tempArray, typeof(int));
            JudgeChargeIRMax    = (int)SliceAndConvert(ref tempArray, typeof(int));
            JudgeChargeIRMix    = (int)SliceAndConvert(ref tempArray, typeof(int));
            JudgeDischargeIRMax = (int)SliceAndConvert(ref tempArray, typeof(int));
            JudgeDischargeIRMix = (int)SliceAndConvert(ref tempArray, typeof(int));
            ResultChargeIR      = (int)SliceAndConvert(ref tempArray, typeof(int));
            ResultDischargeIR   = (int)SliceAndConvert(ref tempArray, typeof(int));
            ResultStatus        = (int)SliceAndConvert(ref tempArray, typeof(int));
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            yield return ResultChargeIR;
            yield return ResultDischargeIR;
            yield return ResultStatus;
        }
    }
}
