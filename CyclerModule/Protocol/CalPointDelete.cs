...
namespace CyclerModule.Protocol
{
    ...
    public class CalPointDelete : ICyclerProtocol, IEnumerable
    {
        //                                  [[[ 설명 ]]]                     [[[ 단위 ]]]     [[[ 비고 ]]]
        private int _mode;                  // 캘 포인트 모드                                 [1: 전압, 2: 전류]
        public int PointValue;              // 캘 포인트 값                  (0.1 mV or mA)   [0: 전체 포인트 삭제, 1~: 포인트 값 (예, 4200mV)]
